...
export const PricingHero: React.FC<PricingHeroProps> = ({ onOpenBooking }) => {
  const shouldReduceMotion = useReducedMotion();

  return (
    <section
      aria-label="Pricing & Tuition Plans Hero"
      className="w-full layout-page-px relative"
    >
      {/* BIG FULL-WIDTH LUXURY CARD (Matching Articles & Courses Royal Identity) */}
      <div className="royal-card-light specular-rim-gold hero-big-card-padding overflow-hidden flex flex-col justify-center relative group h-auto lg:h-[calc(100vh-120px)] min-h-[580px] sm:min-h-[650px] lg:min-h-[680px] lg:max-h-[840px] 2xl:h-[calc(100vh-140px)] 2xl:min-h-[740px] 2xl:max-h-[900px] w-full border border-gold-primary/35 shadow-xl rounded-[28px]">
        ...
        <div className="relative z-10 flex flex-col items-center text-center justify-center max-w-4xl mx-auto py-12 sm:py-16 lg:py-20 2xl:py-24 px-3 sm:px-6 space-y-6 sm:space-y-8">
          ...
          >
            <Crown className="w-3.5 h-3.5 text-gold-dark animate-pulse shrink-0" />
            <span className="text-[10px] sm:text-xs font-extrabold text-gold-dark tracking-wide text-center">
              Transparent &amp; Flexible Global Tuition
            </span>
          </motion.div>

          {/* Headline with Responsive Fluid Typography & Sculpted 3D Engraving */}
          <motion.h1
          ...
          >
            <span className="engraved-emerald sm:whitespace-nowrap">Invest In Quranic Excellence</span>{" "}
            <br className="hidden sm:inline" />
            <span className="engraved-gold italic font-serif sm:whitespace-nowrap">
              With Affordable Global Plans.
            </span>
          </motion.h1>
          ...
          >
            Direct 1-on-1 personalized learning with accredited Al-Azhar University faculty. Flexible weekly schedules, customized curriculums, and 100% money-back guarantee.
          </motion.p>
          ...
          >
            <div className="flex items-center justify-center gap-1.5 royal-card-light px-3.5 py-2 rounded-xl border border-gold-primary/35 shadow-xs">
              <CalendarCheck className="w-3.5 h-3.5 text-gold-dark shrink-0" />
          ...
          {/* Action Buttons (Unified Rounded-xl Geometry) */}
          <motion.div
          ...
          >
            ...
            >
              <CalendarCheck className="w-4 h-4 text-navy-primary shrink-0" />
              <span className="whitespace-nowrap">Start Free 1-on-1 Trial</span>
            ...
            >
              ...
              <span className="whitespace-nowrap">Speak With Academic Advisor</span>
            </Link>
          </motion.div>
